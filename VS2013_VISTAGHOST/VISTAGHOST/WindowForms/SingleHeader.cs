...
namespace Vistaghost.VISTAGHOST
{
    public partial class SingleHeader : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                func.Parameters.Add(new IOType {    Name = (string)dtParamView.Rows[i].Cells[0].Value, 
        ...
        private void InputHeader_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                TextSelection selected = (TextSelection)this.dte2.ActiveDocument.Selection;
                ...
                lblParaNumber.Text = paramList.Count.ToString() + (paramList.Count > 1 ? " parameters" : " parameter");
            }
            catch (Exception ex)
            {
