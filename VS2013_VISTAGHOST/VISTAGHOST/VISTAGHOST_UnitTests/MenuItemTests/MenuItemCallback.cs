...
using Vistaghost.VISTAGHOST;

namespace VISTAGHOST_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new VISTAGHOSTPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(Vistaghost.VISTAGHOST.GuidList.guidVISTAGHOSTCmdSet, (int)Vistaghost.VISTAGHOST.PkgCmdIDList.cmdidVistaghost);
