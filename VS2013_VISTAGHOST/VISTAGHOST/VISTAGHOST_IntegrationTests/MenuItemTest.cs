...
namespace VISTAGHOST_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(Vistaghost.VISTAGHOST.GuidList.guidVISTAGHOSTCmdSet, (int)Vistaghost.VISTAGHOST.PkgCmdIDList.cmdidVistaghost);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "Vistaghost", "Vistaghost.VISTAGHOST.VISTAGHOSTPackage");
